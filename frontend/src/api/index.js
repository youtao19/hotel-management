...
export const ratePlanApi = {
  ...
  getStayDateClosures: (id) => api.get(`/rate-plans/${id}/douyin/stay-date-closures`),

  openStayDate: (id, stayDate) => api.delete(`/rate-plans/${id}/douyin/stay-date-closures/${stayDate}`),
