...
const handoverDailySettings = require("./tables/handover_daily_settings");
const handoverSourceSnapshot = require("./tables/handover_source_snapshot");
...
const system_notification = require("./tables/system_notification");
...
const douyin_presale_booking_order = require("./tables/douyin_presale_booking_order");
...
const douyin_calendar_room_prices = require("./tables/douyin_calendar_room_prices");
const douyin_rate_plan_closure = require("./tables/douyin_rate_plan_closure");
...
tables.push(douyin_calendar_room_rules);
tables.push(douyin_calendar_room_prices);
tables.push(douyin_rate_plan_closure);
...
tables.push(douyin_presale_booking_order);
...
tables.push(handoverSourceSnapshot);
tables.push(dashboard_memo);
tables.push(system_notification);
